...
- explicitly define a problem statement and requirements as if we are starting from scratch (versus adding onto his current site)
...
| Team Member | Contribution / Ownership This Week | Blocker or Next Step |
| ----------- | -------------------------------- | -------------------- |
| Brain Ayo | Created a local prototype | No blockers |
| Trisha Chalikandi | Created a local prototype | No blockers |
| Haya Aman | Created a local prototype | No blockers |
| Mateo Irizarry | Created a local prototype | No blockers |
| Neelesh Polireddy | Created a local prototype | No blockers |
